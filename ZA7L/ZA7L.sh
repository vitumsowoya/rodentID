...
bwa mem -t 12 cytb_db.fa ZA7L_S11_L001_R1_001.fastq.gz ZA7L_S11_L001_R2_001.fastq.gz | samtools view -b - | samtools sort -@ 12 -m 512M -o mapped.sorted.bam
...
cd blast
mv ../final.contigs.fa .
cp /home/vmsowoya/mbewa_study/Version_2/ZA7L/cytb_12.fa .
makeblastdb -in cytb_12.fa  -dbtype nucl -out cytb_db
...
cd phylogeny
cp ../final.contigs.fa .
seqkit grep -r -p "^k79_1\b" final.contigs.fa > ZA7L_cytb_extract.fa #After this, open the new fa file and rename it by replacing contig name with rodent ID
cp /home/vmsowoya/mbewa_study/Version_2/ZA7L/cytb_12.fa .
cat ZA7L_cytb_extract.fa cytb_12.fa > cytb_13.fa
mafft --adjustdirection --auto cytb_13.fa > aligned.fa
trimal -in aligned.fa -out trimmed.fa
sed 's/^>_R_/>/' trimmed.fa > cleaned_13.fa
iqtree -s cleaned_13.fa -m MFP -B 1000 -nt AUTO
